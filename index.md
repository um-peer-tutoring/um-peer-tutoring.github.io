...
<section id="resources" class="resource-section">
  ...
  <div class="card-grid">
    <article class="info-card">
      ...
      <ul class="link-list">
        <li><strong>UMSI:</strong> <a href="https://docs.google.com/spreadsheets/d/1yysrhL4NU9YjcQxBL2rdFVTXEULv2Q7KedEoUycke6M/edit?usp=sharing" target="_blank" rel="noopener">Google Sheet</a></li>
        <li><strong>ECE/CSE:</strong> <a href="https://docs.google.com/spreadsheets/d/12I3PiCiVA8ShNPx4MfZJ8IiDhGO19FkJGYP7-wUERRw/edit?usp=sharing" target="_blank" rel="noopener">Google Sheet</a></li>
      </ul>
    </article>
